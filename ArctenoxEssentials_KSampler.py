...
class KSamplerWithLatent:
    ...
    RETURN_TYPES = ("MODEL", "CONDITIONING", "CONDITIONING", "LATENT", "VAE", "IMAGE", "INT", "INT", "FLOAT", "STRING", "STRING")
    RETURN_NAMES = ("MODEL", "CONDITIONING+", "CONDITIONING-", "LATENT", "VAE", "IMAGE", "seed_used", "steps", "cfg", "sampler_name", "scheduler")
    FUNCTION = "sample"
