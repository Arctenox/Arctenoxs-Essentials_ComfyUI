...
class SaveImageWithMetadata:
        ...
        return {
            ...
            "optional": {
                ...
                "vae_name": ("STRING", {
                    ...
                    "multiline": False,
                    "forceInput": True,
                    "tooltip": "VAE filename for Civitai-compatible metadata (e.g. vae-ft-mse-840000-ema-pruned)"
                }),
                "vae_hash": ("STRING", {
                    "default": "",
                    "multiline": False,
                    "forceInput": True,
                    "tooltip": "VAE SHA256 hash for Civitai detection"
                }),
                "loras": ("STRING", {
                    "default": "",
                    "multiline": True,
    ...
    def save_images(self, images, filename_prefix="ComfyUI", subfolder="", 
                   ...
                   model_hash="", vae_name="", vae_hash="", loras="",
        ...
        for batch_number, image in enumerate(images):
            ...
            if format == "png":
                ...
                a1111_params = self._format_a1111_params(
                    ...
                    images[0].shape[1], images[0].shape[0], parsed_loras, vae_name, vae_hash
                )
            ...
            if format == "png":
                ...
                if positive_prompt or negative_prompt or seed:
                    self._save_metadata_txt(filepath, positive_prompt, negative_prompt,
                                          ...
                                          model_name, model_hash, parsed_loras, vae_name, vae_hash)
            elif format == "webp":
