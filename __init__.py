...
# Prompt Generator
try:
    from .ArctenoxEssentials_PromptGenerator import PromptGenerator
except ImportError as e:
...
def _print_welcome():
    ...
    for item in [
        ...
        "Prompt Generator  — new filter_tags input to exclude unwanted tags",
        "Prompt Finalizer  — coherence-based pruning, bridging & reordering via co-occurrence data",
        "Wildcard Nodes  — Processor, Picker, Stack (fixed & stable)",
    ]:
        print(f"    + {item}")
    print("=" * 62 + "\n")
